...
if (isset($_SESSION['conta'])) {
    ...
    if (!isset($_GET['id']) && !isset($_GET['tipo']) && !isset($_GET['data'])) {
        ...
        if (!isset($_POST['dt_inicio'], $_POST['dt_fim'])) {
            ...
            $gastos = $p->list_automaticos($_SESSION['id'], $_SESSION['ano'] . $_SESSION['mes'], 'G');
        } else {
            $gastos = $p->lista_AutomaticosFiltro($_SESSION['id'], $_POST['dt_inicio'], $_POST['dt_fim'], $_POST['menor_valor'], $_POST['maior_valor'], $_POST['obs'], $_POST['categoria'], $_POST['conta'], 'G');
        }
    } else {
        $dat = $_GET['data'];
                ...
                if (!$erro) {
                    if ($_POST['tipo'] == 1 || $_POST['tipo'] == 2) {
                        ...
                        if ($_POST['repeticao'] == 1) {
                            $p->parcelas_personalizado($_POST['conta'], $_POST['valor'], $_POST['obs'], $_POST['dia_insert'], $_POST['qtd_parcelas'], 'G', 1, 'MONTH', $_POST['categoria'], FALSE);
                        } else {
                            if (isset($_POST['qtd_parcelas'])) {
                                $p->parcelas_personalizado($_POST['conta'], $_POST['valor'], $_POST['obs'], $_POST['dia_insert'], $_POST['qtd_parcelas'], 'G', $_POST['vezes_repeat'], $_POST['periodo'], $_POST['categoria'], FALSE);
                            } else {
                                $p->parcelas_personalizado($_POST['conta'], $_POST['valor'], $_POST['obs'], $_POST['dia_insert'], 0, 'G', $_POST['vezes_repeat'], $_POST['periodo'], $_POST['categoria'], TRUE);
                            }
                        }
        ...
        <div id="main">
            <div class="container" style="box-shadow: none; background-color: transparent; margin-top: 0px;">
                ...
                <div class="container">
                    ...
                    <?php if (isset($_SESSION['conta']) && !isset($_GET['id'],$_GET['tipo'],$_GET['data'])) { ?>
                        ...
                        <div class="esquerda-index">
                            <div class="btn-group" role="group" id="fitros_data" style="margin-top: 3px;">
                                ...
                                if (isset($_POST['dt_inicio']) || isset($_POST['dt_fim'])) {
                                    echo '<a href="editar_gasto_auto.php" class="btn btn-default" style="margin-top: 3px;"
                                   >Limpar Filtros</a>';
                                }
                                ?>
                            </div>
                ...
                <?php } ?>                           
                                        ...
                                        <div class="input-group" id="numero_negativo" style="margin-bottom: 3px;">
                                            ...
                                            <input type="number" class="form-control" name="valor" max="999999999999.99" min="0.01"
                                                   maxlength="13" id="valor" placeholder="50,99" step="0.01" aria-describedby="basic-addon1" 
                ...
                <?php if ($_GET['tipo'] != 3) { ?>
                                            <div id="quantidade-de-parcelas">
                                                ...
                                                <input type="number" class="form-control" name="qtd_parcelas" 
                                                       style="margin-top: -7px; margin-bottom: 3px;" id="qtd_parcelas" min="1" max="100000"
