...
if (isset($_SESSION['conta'])) {
    ...
    if (!isset($_POST['dt_inicio'], $_POST['dt_fim'])) {
        ...
        $gastos = $p->list_entrada($_SESSION['id'], $_SESSION['ano'] . $_SESSION['mes']);
    }else{
        $gastos = $p->lista_entradasFiltro($_SESSION['id'], $_POST['dt_inicio'], $_POST['dt_fim'],$_POST['menor_valor'],$_POST['maior_valor'], $_POST['obs'],$_POST['categoria'],$_POST['conta']);
    }
                                ...
                                <button type="button" class="btn btn-primary" style="margin-top: 3px;"
                                    ...
                                    <span class="glyphicon glyphicon-search"></span> Pesquisar
                                        ...
                                        if (isset($_POST['dt_inicio']) || isset($_POST['dt_fim'])) {
                                            echo '<a href="editar_receita.php" class="btn btn-default" style="margin-top: 3px;"
                                   >Limpar Filtros</a>';
                                        }
                                        ?>
                            </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">Pesquisar Receitas</h4>
                                </div>
