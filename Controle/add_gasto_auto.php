    ...
    <body id="body">
        ...
        <div id="main">
            <div class="container" style="box-shadow: none; background-color: transparent; margin-top: 0px;">
                ...
                <div class="container">
                    <div class="titulo_div"><strong style="margin-left: 4px; margin-right: 4px;">Adicionar Gasto</strong></div>
...
?>" id="actions"/>
                            ...
                            <div class="direita" style="float: right;">
                                ...
                                <input type="number" class="form-control" name="qtd_parcelas"  placeholder="10"  min="1" max="10"
